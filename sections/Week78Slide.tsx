...
import { Link, FormInput, MessageCircleReply, GraduationCap, CheckCircle2 } from 'lucide-react';

const items = [
  { icon: Link, text: 'Koppeling met systeem', done: false },
  { icon: FormInput, text: 'Formulieren instellen en koppelen met de juiste pijplijn', done: false },
  { icon: MessageCircleReply, text: 'Verwerken van de laatste feedback', done: false },
  { icon: GraduationCap, text: 'Accounts instellen en training geven', done: false },
];
    ...
    <section className="h-screen w-screen snap-start relative overflow-hidden flex items-center justify-center bg-[#f8f5ff]">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-4xl">
        <div className="text-center mb-10">
          ...
          >
            Van nest naar{' '}
            <span className="text-brand-green">lucht</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Alles gereed voor jullie vlucht. De laatste stappen naar een volledig werkend systeem.
          </motion.p>
        </div>
