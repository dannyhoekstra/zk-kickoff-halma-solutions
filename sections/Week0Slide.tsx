...
import { FolderOpen, FileText, Users, BarChart3, Mail, LayoutDashboard } from 'lucide-react';

const items = [
  { icon: FileText, text: 'Documentatie en presentatiemateriaal' },
  { icon: Mail, text: 'Voorbeelden van offerte-aanvragen en versturen' },
  { icon: Users, text: 'Voorbeelden van klantcommunicatie' },
  { icon: FolderOpen, text: 'Overzicht van huidige klantsegmenten' },
  { icon: Users, text: 'Werknemers' },
  { icon: LayoutDashboard, text: 'Dashboard van de afgelopen maand' },
];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              <p className="text-gray-500 text-xs mt-1">Wij analyseren en bereiden alles voor voor de technische setup.</p>
            </motion.div>
          </div>
