...
import { Phone, BarChart3, Brain, MessageSquare } from 'lucide-react';

const items = [
  {
    icon: Phone,
    title: 'Bellen en testen',
    desc: 'Zelf klanten bellen om de workflows en scripts in de praktijk te testen.',
  },
  {
    icon: BarChart3,
    title: 'Dashboards inrichten',
    desc: 'Overzicht van de voortgang en prestaties in real-time dashboards.',
  },
  {
    icon: Brain,
    title: 'AI-gespreksanalyse',
    desc: 'AI-gespreksanalyse configureren voor directe feedback op gesprekken.',
  },
  {
    icon: MessageSquare,
    title: 'Evaluatie & feedback',
    desc: 'Overleg aan het eind van week 6 om resultaten te presenteren en feedback te ontvangen.',
  },
];
    ...
    <section className="h-screen w-screen snap-start relative overflow-hidden flex items-center justify-center bg-brand-purple">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        <div className="text-center mb-10">
          ...
          >
            Vlieguren{' '}
            <span className="text-brand-green">maken</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Testen, leren en bijsturen. Intensief aan de slag om alles perfect te krijgen.
          </motion.p>
        </div>
